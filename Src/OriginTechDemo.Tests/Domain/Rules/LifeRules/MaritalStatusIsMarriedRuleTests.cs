...
using OriginTechDemo.Domain.ScoreRules.LifeRules;
using System;
using System.Threading.Tasks;

namespace OriginTechDemo.Tests.Rules.Domain.LifeRules
{
    [TestClass]
    public class MaritalStatusIsMarriedRuleTests
    {
        ...
        [TestMethod]
        public async Task ShouldReturnOneIfTheUserIsMarried()
        {
